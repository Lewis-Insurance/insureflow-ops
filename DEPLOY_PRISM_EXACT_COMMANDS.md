...
```bash
supabase secrets set PRISM_SYSTEM_API_KEY=sk_prism_w0gBfAGoMgJmVfGz40cxB3WvS4HpU5sv --project-ref lrqajzwcmdwahnjyidgv
```
...
curl -X POST https://lrqajzwcmdwahnjyidgv.supabase.co/functions/v1/prism-api/run \
  -H "Authorization: Bearer sk_prism_w0gBfAGoMgJmVfGz40cxB3WvS4HpU5sv" \
