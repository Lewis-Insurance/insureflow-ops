...
import { UserPlus, Loader2, Pencil, Trash2, Key, Eye, EyeOff } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage existing users, edit their information, or remove access.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add new users to the system. They will receive login credentials via email.
          </CardDescription>
        </CardHeader>
        <CardContent>
