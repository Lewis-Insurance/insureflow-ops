      ...
      <Card>
        <CardContent className="pt-6 text-center">
          <p className="text-muted-foreground">
            Unable to load retention analytics. Please try again.
          </p>
        </CardContent>
      </Card>
    );
            ...
            {data.byCarrier.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-xs mt-1">
                  When you mark renewals as "moved", carrier breakdown will appear here
                </p>
              </div>
            ) : (
              <Table>
          ...
          <CardContent>
            {data.byTerm.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-xs mt-1">
                  Term breakdown will appear when policies are moved
                </p>
              </div>
            ) : (
              <Table>
