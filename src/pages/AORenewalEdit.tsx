...
function loadPanelPrefs() {
  if (typeof window === "undefined") {
    return { details: true, exceptions: true, followUp: true, workspace: true };
  }

  try {
    const raw = window.localStorage.getItem(PANEL_PREFS_KEY);
    if (!raw) return { details: true, exceptions: true, followUp: true, workspace: true };
    return { details: true, exceptions: true, followUp: true, workspace: true, ...JSON.parse(raw) };
  } catch {
    return { details: true, exceptions: true, followUp: true, workspace: true };
  }
}
