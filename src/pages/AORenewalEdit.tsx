            ...
            <div className="mt-6 grid gap-4 xl:grid-cols-[1.4fr_1fr]">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  ...
                  <div>
                    <div className="text-xs uppercase tracking-[0.2em] text-slate-500">Assigned Owner</div>
                    <div className="mt-2 text-2xl font-semibold text-white">{assignedProfile?.full_name || "Unassigned"}</div>
                    <p className="mt-2 text-sm text-slate-400">Last contact {formData.last_contact_date ? formatLocalDateDisplay(formData.last_contact_date) : "not logged"}</p>
                  </div>
                </div>
              </div>
