    ...
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant={metricType === 'activity' ? 'default' : 'outline'}
            size="sm"
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-base">Your daily target progress</CardDescription>
            </div>
            <Link to="/leads">
      ...
      <Tabs defaultValue="trend" className="space-y-4">
        ...
        <TabsContent value="pipeline" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>My Pipeline Distribution</CardTitle>
              <CardDescription>Current leads across all stages</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart
                  data={[
                    { stage: 'New', count: metrics.pipeline.new, color: '#3b82f6' },
                    { stage: 'Contacted', count: metrics.pipeline.contacted, color: '#8b5cf6' },
                    { stage: 'Qualified', count: metrics.pipeline.qualified, color: '#eab308' },
                    { stage: 'Quoted', count: metrics.pipeline.quoted, color: '#f97316' },
                    { stage: 'Won', count: metrics.pipeline.won, color: '#10b981' },
                    { stage: 'Lost', count: metrics.pipeline.lost, color: '#ef4444' },
                    { stage: 'Nurturing', count: metrics.pipeline.nurturing, color: '#6b7280' },
                  ]}
                >
                  <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
