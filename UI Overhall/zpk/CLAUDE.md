# Lewis Insurance Agency OS - Build Rules (Claude Code)
...
Claude Code: keep this file and the `design-system/` folder at the project root. Start a build from `design-system/builder-prompt.md`.
