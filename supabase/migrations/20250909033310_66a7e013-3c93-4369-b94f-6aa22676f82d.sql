...
ALTER TABLE public.notes ADD COLUMN IF NOT EXISTS type note_type DEFAULT 'general';
...
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS status task_status DEFAULT 'todo';
