-- ============================================================================
-- FIX: CEO DIGEST QUOTE STATUS ENUM VALUES
-- ============================================================================
-- The quote_status enum is: 'open', 'won', 'lost', 'expired'
-- The RPC was using incorrect values: 'sent', 'accepted', 'declined', 'draft'
--
-- Mapping:
--   'open' = active/pending quotes (was 'sent'/'draft')
--   'won' = accepted quotes (was 'accepted')
--   'lost' = declined quotes (was 'declined')
-- ============================================================================
...
COMMENT ON FUNCTION get_ceo_digest_facts_all_agencies IS
  'Computes aggregated metrics across ALL agency workspaces for CEO-level digest. Fixed quote_status enum values.';
