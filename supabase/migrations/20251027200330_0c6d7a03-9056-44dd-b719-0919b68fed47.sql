-- Fix nurture_campaigns status reference: use boolean 'active' column instead of non-existent 'status'

-- Recreate function to check campaign trigger match
...
BEGIN
  ...
  -- Fetch campaign and conditions (active campaigns only)
  SELECT * INTO v_campaign
  FROM public.nurture_campaigns 
...
-- Recreate function to auto-enroll leads in active campaigns
