# InsureFlow Ops — Codex Instructions
...
Subagents load [`CLAUDE.md`](./CLAUDE.md) for InsureFlow Ops architecture and invariants.
Orchestrator playbook and tool mapping: [`ORCHESTRATOR.md`](./ORCHESTRATOR.md).
